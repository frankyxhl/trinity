...
{
  "providers": {
    "glm":     { "cli": "droid exec --auto medium --model custom:GLM-5.2 --reasoning-effort high", "installed": true },
...
| Provider | Status    | CLI                              |
|----------|-----------|----------------------------------|
| glm      | ✅ usable  | droid exec --auto medium --model custom:GLM-5.2 --reasoning-effort high |
