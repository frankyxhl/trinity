...
| (TBD) | #88 (TRN-3032, fast-review tier) | Worker (multi-section SOP) | 2-round (R1 mean 9.09, R2 mean 9.535) — first CHG to ship under fast-review tier (panels 4→2; gate 9.0→9.5) | (TBD at code-review time) | R1-R2 plan-review | TBD at merge |
