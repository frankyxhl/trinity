...
| 2026-06-15 | Added machine-readable `Overlays: COR-1617` umbrella binding after COR disposition reconciliation; subordinate cluster docs remain mapped in §0 and `Related`. | Codex |
