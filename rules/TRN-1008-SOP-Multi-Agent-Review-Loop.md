...
- **Never start Phase 2 without comprehension check PASS** [#92]: Phase 1 PASS triggers the §1.5 comprehension check; only the PROCEED outcome advances to Phase 2 branch hygiene. CLARIFY defers; REJECT declines.
