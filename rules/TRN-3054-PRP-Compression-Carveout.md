...
3. TRN-1008 §3/§4 plan-template requirement (normative): a CHG entering plan-review MUST declare, in its surface enumeration, per-block added/deleted/merged character estimates for every planned test block (merged defaulting to 0 unless a consolidation is declared) - without these, §4 compression and the exclusion are uncomputable, and the plan-review verdict is malformed.
