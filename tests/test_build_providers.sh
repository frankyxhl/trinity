...
PROVIDERS=(codex gemini glm minimax openrouter deepseek claude-code)
NATIVE=(codex gemini glm minimax)
...
check "glm CLI signature"        grep -q 'droid exec --auto medium --model glm-5.2 --reasoning-effort high' providers/glm.md
